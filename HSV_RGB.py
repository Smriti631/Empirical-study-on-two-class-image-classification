...
f = open('/home/smriti/Desktop/project_python/refined_programs/hsv_rgb_data.csv','w')
print >>f,"Path,Red,Green,Blue,Hue,Saturation,Value,Class"
def cal_rgb(img,flag):
     ...
     #   print img+","+str(r_avg)+","+str(g_avg)+","+str(b_avg)+","+str(flag)
        print >>f,img+","+str(r_avg)+","+str(g_avg)+","+str(b_avg)+","+str(h_avg)+","+str(s_avg*100)+","+str(v_avg*100)+","+str(flag)
       # print sum
