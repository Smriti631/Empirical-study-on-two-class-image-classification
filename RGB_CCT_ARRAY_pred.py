...
#knn classifier....
df=pd.read_csv('/home/smriti/Desktop/project_python/refined_programs/RGB_CCT_ARRAY.data.txt')
...
f = open('/home/smriti/Desktop/project_python/refined_programs/RGB_CCT_ARRAY_pred.csv','w')
...
def cal_rgb(img,flag):
      ...
      #  print img                        
        ...
        example_measures=np.array([r,g,b,CCT])
