...
#knn classifier....
df=pd.read_csv('/home/smriti/Desktop/project_python/refined_programs/RGB_HSV_MERGED.data.txt')
...
f = open('/home/smriti/Desktop/project_python/refined_programs/RGB_HSV_MERGED.data_pred.csv','w')
...
def cal_rgb(img,flag):
     ...
     #  print img+","+str(r_avg)+","+str(g_avg)+","+str(b_avg)+","+str(flag)
      # print str(r_avg)+","+str(g_avg)+","+str(b_avg)+","+str(h_avg)+","+str(s_avg)+","+str(v_avg)
        example_measures=np.array([r,g,b,H,S,V])
