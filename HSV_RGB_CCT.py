...
f = open('/home/smriti/Desktop/project_python/refined_programs/HSV_RGB_CCT.csv','w')
print >>f,"Path,Red,Green,Blue,Hue,Saturation,Value,CCT,Class"
def cal_rgb(img,flag):
     ...
     #   print img+","+str(r_avg)+","+str(g_avg)+","+str(b_avg)+","+str(flag)
        print >>f,img+","+str(r_avg)+","+str(g_avg)+","+str(b_avg)+","+str(h_avg)+","+str(s_avg)+","+str(v_avg)+","+str(cct_avg)+","+str(flag)
       # print sum
